...
%This is combining channel with Hybrid Precoding and optimised Power allocation and getting the final
%curve.
...
G_BS=192; % Required resolution for BS AoD(N)
G_MS=192; % Required resolution for MS AoA(N)

K_BS=2;  % Number of Beamforming vectors per stage (K)
K_MS=2;  % Number of Measurement vectors per stage(K)
...
%Generating the "G" matrix to construct the ideal
